...
```
**query for:finding total rental income wrt category**
```sql
...
**query for:creating a table of books with rental price above a certain threshold 7 usd**
```sql
